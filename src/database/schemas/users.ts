...
export const subscriptionPlansEnum = pgEnum('plans', [SUBSCRIPTION_PLANS.BASIC, SUBSCRIPTION_PLANS.PRO]);
...
export const UserTable = pgTable('users',{
    ...
    plan:uuid('plan').references(()=>SubscriptionPlansTable.id, { onDelete: 'cascade' }  ).notNull()
})
